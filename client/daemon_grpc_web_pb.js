 ...
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.daemon.Empty,
 *   !proto.daemon.ListCategoriesResponse>}
 */
const methodDescriptor_Daemon_ListCategories = new grpc.web.MethodDescriptor(
  '/daemon.Daemon/ListCategories',
  grpc.web.MethodType.UNARY,
  proto.daemon.Empty,
  proto.daemon.ListCategoriesResponse,
  /** @param {!proto.daemon.Empty} request */
  ...
  proto.daemon.ListCategoriesResponse.deserializeBinary
);
 ...
 *   !proto.daemon.ListCategoriesResponse>}
 */
const methodInfo_Daemon_ListCategories = new grpc.web.AbstractClientBase.MethodInfo(
  proto.daemon.ListCategoriesResponse,
  /** @param {!proto.daemon.Empty} request */
  function(request) {
    return request.serializeBinary();
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.daemon.ListCategoriesResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.daemon.ListCategoriesResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.daemon.DaemonClient.prototype.listCategories =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/daemon.Daemon/ListCategories',
      request,
      metadata || {},
      methodDescriptor_Daemon_ListCategories,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.daemon.ListCategoriesResponse>}
 *     A native promise that resolves to the response
 */
proto.daemon.DaemonPromiseClient.prototype.listCategories =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/daemon.Daemon/ListCategories',
      request,
