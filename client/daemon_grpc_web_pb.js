 ...
 */
const methodDescriptor_Daemon_UpdateExercisesFile = new grpc.web.MethodDescriptor(
  '/Daemon/UpdateExercisesFile',
  grpc.web.MethodType.UNARY,
  proto.Empty,
  proto.UpdateExercisesFileResponse,
  /**
  ...
  proto.UpdateExercisesFileResponse.deserializeBinary
);
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.UpdateExercisesFileResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.UpdateExercisesFileResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.DaemonClient.prototype.updateExercisesFile =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/Daemon/UpdateExercisesFile',
      request,
      metadata || {},
      methodDescriptor_Daemon_UpdateExercisesFile,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.UpdateExercisesFileResponse>}
 *     A native promise that resolves to the response
 */
proto.DaemonPromiseClient.prototype.updateExercisesFile =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/Daemon/UpdateExercisesFile',
      request,
